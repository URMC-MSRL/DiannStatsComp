#'
#' @description Combines `set_metadata()`, `get_phospho_log()`, `get_stats()`, and `merge_stats()` into a single function. This is used if there is a stats report file created for both the First-Pass and MBR search results for a DIA-NN search with only oxidation set as a variable mod of M.
#'
...
#' @importFrom magrittr %>%
#' 
global_summarized <- function(log_data,
