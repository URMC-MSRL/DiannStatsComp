#'
#' @description Combines `set_metadata()`, `get_phospho_log()` and `get_stats()` into a single function.This is used if there is no stats report file created for the First-Pass search results for a DIA-NN search with only oxidation set as a variable mod of M.
#'
...
#' @importFrom magrittr %>%
#' 
global_summarized_no_firstPass <- function(log_data,
                                           stats_tsv,
